...
.. code-block:: python
   ...
   # Plot the simple distribution
   plt.hist(counts, bins=10, range=(0, 10), color='royalblue', edgecolor='black')
   plt.title("Number of High $p_T$ Tops per Event")
   plt.xlabel("Tops ($p_T > 500$ GeV)")
   plt.ylabel("Events")
   
   plt.savefig("high_pt_tops_distribution.pdf")
   print("Saved plot to high_pt_tops_distribution.pdf!")
