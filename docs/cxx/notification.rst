...
.. cpp:class:: notification
    ...
    **Public Functions**
    ...
    .. cpp:function:: void success(std::string message)
    ...
    .. cpp:function:: void warning(std::string message)
    ...
    .. cpp:function:: void failure(std::string message)
    ...
    .. cpp:function:: void progressbar(float lProgress, std::string title)
    ...
    .. cpp:function:: void progressbar(std::vector<size_t>* threads, std::vector<size_t>* trgt, std::vector<std::string>* title)
    ...
    .. cpp:function:: void monitor(std::vector<std::thread*>* thr)
    ...
    .. cpp:function:: int running(std::vector<std::thread*>* thr, std::vector<size_t>* prg, std::vector<size_t>* trgt)
    ...
    .. cpp:function:: static void progressbar1(std::vector<size_t>* threads, size_t l, std::string title)
    ...
    .. cpp:function:: static void progressbar2(std::vector<size_t>* threads, size_t* l, std::string* title)
    ...
    .. cpp:function:: static void progressbar3(std::vector<size_t>* threads, std::vector<size_t>* l, std::vector<std::string*>* title)
    ...
    **Private Members**
    ...
    .. cpp:function:: template <typename g> g sum(const std::vector<g>* inpt)
