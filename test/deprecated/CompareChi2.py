...
Ana = Analysis()
Ana.InputSample("bsm4t-1000-All", "/home/tnom6927/Downloads/samples/Dilepton/ttH_tttt_m1000")
...
t_solCR = NuC.NuNuPtEtaPhiE(T.b_, T.b, T.mu_, T.mu, T.met, T.phi, T.mT, T.mW, T.mN, 1e-12)
