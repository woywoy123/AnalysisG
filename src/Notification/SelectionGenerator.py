...
class _SelectionGenerator(Notification):
    ...
    def CheckSettings(self):
        if len(self.Selections) == 0 and len(self.Merge) == 0: return self.Warning("No Selection was specified...")
        if len(self) == 0: return self.Failure("No compiled events were found...")
