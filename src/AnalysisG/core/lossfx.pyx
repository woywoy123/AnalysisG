...
cdef class OptimizerConfig:
    ...
    @property
    def Scheduler(self): return env(self.params.scheduler)
    @Scheduler.setter
    ...
    @step_size.setter
    def step_size(self, int val): self.params.step_size = val

    @property
    def gamma(self): return self.params.gamma
    @gamma.setter
    def gamma(self, double val): self.params.gamma = val
