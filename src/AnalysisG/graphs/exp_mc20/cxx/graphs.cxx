...
void graph_jets::CompileEvent(){
    exp_mc20* event = this -> get_event<exp_mc20>(); 
...
//    // ---------------- truth ------------------- //
//    this -> add_graph_truth_feature<bool, exp_mc20>(event, signal_event, "signal"); 
//    this -> add_graph_truth_feature<int , exp_mc20>(event, num_lepton  , "n_lep"); 
//    this -> add_graph_truth_feature<int , exp_mc20>(event, num_tops    , "ntops"); 
//
...
//
//    // ---------------- data -------------------- //
//    this -> add_graph_data_feature<double, exp_mc20>(event, missing_et, "met"); 
//    this -> add_graph_data_feature<double, exp_mc20>(event, missing_phi, "phi"); 
//    this -> add_graph_data_feature<double, exp_mc20>(event, num_jets, "num_jets"); 
//    this -> add_graph_data_feature<double, exp_mc20>(event, num_children_leps, "num_leps"); 
//    this -> add_graph_data_feature<double, exp_mc20>(event, event_weight, "weight"); 
//    this -> add_graph_data_feature<long  , exp_mc20>(event, event_number, "event_number"); 
//
...
void graph_jets_detector_lep::CompileEvent(){
    ...
    //this -> add_graph_data_feature<double, exp_mc20>(event, missing_phi, "phi"); 
    //this -> add_graph_data_feature<double, exp_mc20>(event, num_jets, "num_jets"); 
    //this -> add_graph_data_feature<double, exp_mc20>(event, num_leps, "num_leps"); 
    //this -> add_graph_data_feature<double, exp_mc20>(event, event_weight, "weight"); 
    //this -> add_graph_data_feature<long  , exp_mc20>(event, event_number, "event_number"); 
