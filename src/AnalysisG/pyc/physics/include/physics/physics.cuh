/**
 * @file physics.cuh
 * @brief Provides physics-related functions for CUDA operations.
 */
...
/**
 * @brief Computes the square of the momentum.
 *
 ...
 * @return A tensor containing the square of the momentum.
 */
torch::Tensor P2(torch::Tensor* px, torch::Tensor* py, torch::Tensor* pz);

/**
 * @brief Computes the square of the momentum from a momentum tensor.
 *
...
/**
 * @brief Computes the momentum.
 *
 * @param px Input tensor for the x-component of momentum.
 * @param py Input tensor for the y-component of momentum.
 * @param pz Input tensor for the z-component of momentum.
 * @return A tensor containing the momentum.
 */
torch::Tensor P(torch::Tensor* px, torch::Tensor* py, torch::Tensor* pz);

/**
 * @brief Computes the momentum from a momentum tensor.
 *
 * @param pmc Input tensor for the momentum components.
 * @return A tensor containing the momentum.
 */
