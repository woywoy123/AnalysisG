...
struct optimizer_params_t {
    ...
    void static set_lr(double*, optimizer_params_t* obj){obj -> m_lr = true;}
    void static set_lr_decay(double*, optimizer_params_t* obj){obj -> m_lr_decay = true;}
    void static set_weight_decay(double*, optimizer_params_t* obj){obj -> m_weight_decay = true;}
    void static set_initial_accumulator_value(double*, optimizer_params_t* obj){obj -> m_initial_accumulator_value = true;}
    void static set_eps(double*, optimizer_params_t* obj){obj -> m_eps = true;}
    void static set_betas(std::tuple<float, float>*, optimizer_params_t* obj){obj -> m_betas = true;}
    void static set_amsgrad(bool*, optimizer_params_t* obj){obj -> m_amsgrad = true;}
    void static set_max_iter(int*, optimizer_params_t* obj){obj -> m_max_iter = true;}
    void static set_max_eval(int*, optimizer_params_t* obj){obj -> m_max_eval = true;}
    void static set_tolerance_grad(double*, optimizer_params_t* obj){obj -> m_tolerance_grad = true;}
    void static set_tolerance_change(double*, optimizer_params_t* obj){obj -> m_tolerance_change = true;}
    void static set_history_size(int*, optimizer_params_t* obj){obj -> m_history_size = true;}
    void static set_centered(bool*, optimizer_params_t* obj){obj -> m_centered = true;}
    void static set_nesterov(bool*, optimizer_params_t* obj){obj -> m_nesterov = true;}
    void static set_alpha(double*, optimizer_params_t* obj){obj -> m_alpha = true;}
    void static set_momentum(double*, optimizer_params_t* obj){obj -> m_momentum = true;}
    void static set_dampening(double*, optimizer_params_t* obj){obj -> m_dampening = true;}
