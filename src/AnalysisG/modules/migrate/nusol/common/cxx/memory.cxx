...
long double _trace(long double** A, int lx){
    long double o = 0; 
    for (int i(0); i < lx; ++i){ o += A[i][i];}
    return o; 
}
...
long double _det3(long double** v){return v[0][0] * _m_00(v) - v[0][1] * _m_01(v) + v[0][2] * _m_02(v);}
long double _det2(long double** v){return v[0][0] * v[1][1] - v[1][0] * v[0][1];}
