...
void Conuix::Mobius_t::init(base_t* base){
    ...
    auto dfx = [this](long double x, long double a_x, long double b_x, long double c_x){
        long double bx = this -> alpha_m(x); 
