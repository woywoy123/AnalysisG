...
#define __PYX_HAVE__analysisg__cmodules__tools__tools
#define __PYX_HAVE_API__analysisg__cmodules__tools__tools
/* Early includes */
#include <string.h>
#include <string>
#include "ios"
...
#define __Pyx_MODULE_NAME "analysisg.cmodules.tools.tools"
extern int __pyx_module_is_main_analysisg__cmodules__tools__tools;
int __pyx_module_is_main_analysisg__cmodules__tools__tools = 0;

/* Implementation of "analysisg.cmodules.tools.tools" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_analysisg__cmodules__tools__tools) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "analysisg.cmodules.tools.tools")) {
      if (unlikely((PyDict_SetItemString(modules, "analysisg.cmodules.tools.tools", __pyx_m) < 0))) __PYX_ERR(2, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "analysisg/cmodules/tools/tools.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init analysisg.cmodules.tools.tools", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init analysisg.cmodules.tools.tools");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
