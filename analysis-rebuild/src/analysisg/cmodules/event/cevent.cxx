...
#define __PYX_HAVE__analysisg__cmodules__event__event
#define __PYX_HAVE_API__analysisg__cmodules__event__event
/* Early includes */
#include <string.h>
#include <string>
#include "ios"
...
/* Module declarations from "analysisg.cmodules.event.event" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "analysisg.cmodules.event.event"
extern int __pyx_module_is_main_analysisg__cmodules__event__event;
int __pyx_module_is_main_analysisg__cmodules__event__event = 0;

/* Implementation of "analysisg.cmodules.event.event" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_analysisg__cmodules__event__event) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "analysisg.cmodules.event.event")) {
      if (unlikely((PyDict_SetItemString(modules, "analysisg.cmodules.event.event", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "analysisg/cmodules/event/event.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init analysisg.cmodules.event.event", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init analysisg.cmodules.event.event");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
